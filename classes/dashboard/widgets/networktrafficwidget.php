...
namespace Dashboard\Widgets {
     ...
     * @author Rob Bogie
     */
    class NetworkTrafficWidget implements \Dashboard\Ajax\AjaxWidget {
        private $networkTrafficTemplate;
        private $tableRowTemplate;
        public function __construct() {
            $this->networkTrafficTemplate = new \Dashboard\System\Template("NetworkTrafficWidget.tpl");
            $this->tableRowTemplate = new \Dashboard\System\Template("NetworkTrafficWidgetRow.tpl");
